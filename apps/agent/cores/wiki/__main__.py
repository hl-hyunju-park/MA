"""Visualize the agent's LangGraph structure.
    ...
    python -m apps.agent.cores.wiki                 # print Mermaid to stdout
    python -m apps.agent.cores.wiki --out FILE.mmd  # also write the Mermaid source
    python -m apps.agent.cores.wiki --png FILE.png  # render a PNG (needs network: mermaid.ink)
